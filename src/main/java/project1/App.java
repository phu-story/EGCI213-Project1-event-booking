...
public class App {
    public static void main(String[] args) {
        ...
        for (Booking b : booking) {
            ...
            System.out.printf("Booking %3s, customer %s  >>  days = %2d, persons = %d, rooms = [%d, %d, %d], meals = [%d, %d, %d]\n", b.getBookingId(), b.getCustomerId(), b.getDay(), b.getPerson(), roomPerDay[0], roomPerDay[1], roomPerDay[2], mealPerPersonPerDay[0], mealPerPersonPerDay[1], mealPerPersonPerDay[2]);
        ...
        for (Customer c : customers) {
            ...
            for (Booking b : c.getBookings()) {
                ...
                out+=b.getBookingId();
                counter++;
                if(counter < c.getBookings().size()) out+=", ";
            }
            out+="]";
